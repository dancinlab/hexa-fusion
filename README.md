...
| `hexa run tests/test_calculators.hexa` | ✅ PASS | calc_*/numerics_* sentinel sweep (7 cases including numerics_tabletop_parity) |
| `hexa-fusion verify all`               | ✅ PASS | RSC inventory: 9 verify/*.hexa (T1 4 + T2 5), aggregate 9/9 |
