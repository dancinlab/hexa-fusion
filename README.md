...
| `hexa run tests/test_calculators.hexa` | ✅ PASS | calc_*/numerics_* sentinel sweep (8 cases including numerics_powerplant) |
| `hexa-fusion verify all`               | ✅ PASS | RSC inventory: 10 verify/*.hexa (T1 4 + T2 6), aggregate 10/10 |
