...
| `hexa run tests/test_calculators.hexa` | ✅ PASS | calc_*/numerics_* sentinel sweep (6 cases including numerics_tabletop) |
| `hexa-fusion verify all`               | ✅ PASS | RSC inventory: 8 verify/*.hexa (T1 4 + T2 4), aggregate 8/8 |
