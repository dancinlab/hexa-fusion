...
| `hexa run tests/test_calculators.hexa` | ✅ PASS | calc_*/numerics_* sentinel sweep (10 cases including numerics_cross_pillar) |
| `hexa-fusion verify all`               | ✅ PASS | RSC inventory: 12 verify/*.hexa (T1 4 + T2 8), aggregate 12/12 |
