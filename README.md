...
| `hexa run tests/test_calculators.hexa` | ✅ PASS | calc_*/numerics_* sentinel sweep (9 cases including numerics_powerplant_dse) |
| `hexa-fusion verify all`               | ✅ PASS | RSC inventory: 11 verify/*.hexa (T1 4 + T2 7), aggregate 11/11 |
